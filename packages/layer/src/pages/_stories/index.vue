<template>
  <div class="grid grid-cols-[auto,minmax(0,1fr)] h-full">
    ...
    >
      <header class="h-16 w-full overflow-auto p-4 border-b border-neutral-600 flex items-center gap-8">
        ...
        <div class="grid p-4" v-if="state.controls.open">
          ...
          >
            <details>
              ...
              <pre
                class="text-xs text-neutral-300 p-1 rounded-lg bg-black/40 my-0.5"
